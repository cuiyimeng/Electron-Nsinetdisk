<template>
  <div class="file">
    ...
    <div class="file-list">
      <md-list>
        <md-subheader class="s-box md-inset">正在下载: </md-subheader>
          ...
          <md-theme md-name="download">
            <md-list-item>
              ...
              <md-button @click="stop(i.fileid)" class="md-icon-button md-list-action">
                ...
                <md-tooltip md-direction="bottom">取消下载</md-tooltip>
              </md-button>
            </md-list-item>
          </md-theme>
        </div>
    ...
    <div class="file-list">
      <md-list>
        <md-subheader class="s-box md-inset">已下载: </md-subheader>
          ...
          <md-theme md-name="downloaded">
            <md-list-item>
              ...
              <md-button class="md-icon-button md-list-action">
                ...
                <md-tooltip md-direction="bottom">打开下载文件夹</md-tooltip>
              </md-button>
            </md-list-item>
          </md-theme>
        </div>
...
export default {
  ...
  mounted () {
    ...
    this.list.downloaded = {
      'lksosj': {'name': 'main.py', 'size': '11111M', 'type': 'code', 'fileid': 'lksosj'},
      'lksoss': {'name': 'main.py', 'size': '11111M', 'type': 'code', 'fileid': 'lksoss'},
      'aksosj': {'name': 'main.py', 'size': '11111M', 'type': 'videocam', 'fileid': 'aksosj'}
    }
  },
  methods: {
    stop (id) {
